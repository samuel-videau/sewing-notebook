...
export function verifyJWT(req: FastifyRequest, res: FastifyReply, userId: string) {
	...
	if (userId !== payload.userId) return res.code(403).send(error(403, ERROR_UNAUTHORIZED));
